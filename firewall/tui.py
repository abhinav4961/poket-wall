...
Redesigned for better aesthetics and functionality.
"""
...
class TUI:
    """Curses-based IDS dashboard — redesigned."""
    ...
    def _draw_main(self, stdscr, h, w):
        ...
        keys = "[q]Quit [g]Geo [t]Threshold [c]Clear [b]Blocked [a]AI Dashboard [Up/Down]Scroll"
